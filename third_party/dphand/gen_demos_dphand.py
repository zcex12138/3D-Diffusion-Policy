...
def main(args):
	save_dir = os.path.join(args.root_dir, 'dphand_'+ args.env_name + '_expert.zarr')
	...
	# 创建环境
	env = DphandPickCubeEnv(render_mode="human", image_obs=True, image_size=128)
...
if __name__ == "__main__":
	...
	parser.add_argument('--env_name', type=str, default='pick_cube' )
	parser.add_argument('--root_dir', type=str, default="/home/yhx/workspace/3D-Diffusion-Policy/3D-Diffusion-Policy/data/dphand_0920" )
